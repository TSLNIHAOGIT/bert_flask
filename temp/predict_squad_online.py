...
def input_fn_builder(input_file, seq_length, is_training, drop_remainder):
  ...
  def input_fn(params):
    ...
    all = []
    eval_features = input_file
    all.append([f.unique_ids for f in eval_features])
    all.append([f.input_ids for f in eval_features])
    all.append([f.input_mask for f in eval_features])
    all.append([f.segment_ids for f in eval_features])

    d = tf.data.Dataset.from_tensor_slices(all)
